      ...
      <DialogContent className="sm:max-w-md">
        <DialogHeader>
          ...
          <DialogDescription asChild>
            <div className="pt-2">
              <button type="button" onClick={() => setShowImage(true)} className="group block overflow-hidden rounded-lg border" title={t('about.imageHint')}>
                <img src={splashUrl} alt={t('about.imageHint')} className="h-28 w-full object-cover transition group-hover:opacity-90"/>
              </button>
        ...
        <button type="button" onClick={() => void window.api.ui.openExternal(SOURCE_URL)} className="flex w-full items-center justify-between gap-2 rounded-lg border bg-muted/50 px-3 py-2 text-left text-sm hover:bg-muted/80" title={SOURCE_URL}>
