...
export function SplashScreen({ onDone }: Props): React.JSX.Element {
  ...
  return (
    <div
      className="fixed inset-0 z-[100] flex items-center justify-center overflow-hidden bg-black transition-opacity duration-700 ease-in-out"
    ...
    >
      {failed ? (
        ...
        <img
          src={splashUrl}
          alt=""
          className="max-h-[80vh] max-w-[80vw] object-contain transition-opacity duration-1000 ease-in-out"
