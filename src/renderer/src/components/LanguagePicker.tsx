      ...
      <CardContent>
        <div className="grid grid-cols-2 gap-2 sm:grid-cols-3">
          {locales.map((l) => {
            ...
            return (<button key={l.id} type="button" onClick={() => pick(l.id)} className={cn('flex flex-col items-start gap-0.5 rounded-lg border px-3 py-2 text-left transition', active
