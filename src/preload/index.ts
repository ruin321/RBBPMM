...
const api: AppApi = {
    ...
    banana: {
        search: (page, query, category) => ipcRenderer.invoke('banana:search', { page, query, category }),
    ...
    configs: {
        ...
        set: (cfgPath, section, key, value) => ipcRenderer.invoke('configs:set', { cfgPath, section, key, value }),
